...
if __name__ == '__main__':
    ...
    def getTrainOrTestCSV(datalist, csv_txt, jsonFilePathList):
        ...
        csv_data = []
        csv_data.append('NOF,NOPF,NOM,NOPM,LOC,WMC,NC,DIT,LCOM,FANIN,FANOUT,label\n')
    ...
    for i in range(times):
        ...
        for item in trainlist:
            ...
            if projectname == 'ant':
                projectname = 'Ant'
            jsonFilePath = datasetPath+projectname+"/types/rawjson/"+item.split('    ')[0][:-5]+'.json'
        ...
        feature_list = ['NOF','NOPF','NOM','NOPM','LOC','WMC','NC','DIT','LCOM','FANIN','FANOUT']
