...
def build_tokens(code_path):
    ...
    tokenizer = AutoTokenizer.from_pretrained("/model/LiangXJ/Model/microsoft/codebert-base")
...
def build(code_path, file_name, batch_size=64):
    ...
    model = AutoModel.from_pretrained("/model/LiangXJ/Model/microsoft/codebert-base")
